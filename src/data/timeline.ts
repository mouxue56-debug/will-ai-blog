...
export const timelineData: TimelineEntry[] = [
  ...
  },
  {
    ...
    content: {
      ...
      ja: '暁棉の誕生日にティラミスケーキでサプライズしたくて。ケーキ作り初体験、AIに5つのレシピを比較してもらい、初心者向けのバージョンを特定。途中でマスカルポーネの泡立てが足りない問題に遭遇、リアルタイムでAIに対処法を聞いた。最終的になんとか完成、見た目はまあまあだけど味は良い。暁棉は大喜び、「AI手伝いでケーキ作るの反則でしょ」とのこと。生活でAIが役立つシーンは想像以上に多い。',
