...
export const timelineData: TimelineEntry[] = [
  ...
  },
  {
    ...
    category: 'milestone',
    isMilestone: true,
    tags: ['AI', 'Automation', 'n8n', 'Maker'],
    title: {
      zh: '深入学习 AI 自动化，掌握 n8n 和工作流工具',
      ja: 'AI自動化を深く学び、n8nとワークフローツールをマスター',
      en: 'Deep Dive into AI Automation — Learning n8n and Workflow Tools',
    },
    summary: {
      zh: '从理论到实践，系统学习 n8n 工作流自动化和 AI Agent 串联。',
      ja: '理論から実践へ、n8nワークフロー自動化とAIエージェント串联を体系的に学ぶ。',
      en: 'From theory to practice — systematically learning n8n workflow automation and AI agent orchestration.',
    },
    content: {
      zh: '2025年，开始深入学习AI自动化和工作流工具。不是停留在概念层面，而是真正动手用n8n搭建自动化流程。主要学习方向：n8n工作流搭建、AI Agent串联、API集成、Trigger机制设计。通过实际项目掌握了从简单的自动回复到复杂的多步骤业务流程搭建。这为后来的AI客服业务打下了坚实的技术基础。',
      ja: '2025年、AI自動化とワークフローツールの学習を深いレベルに進めた。概念の理解だけでなく、実際にn8nを使って自動化フローを構築。主な学習方向：n8nワークフロー構築、AIエージェント串联、API統合、Triggerメカニズム設計。実際のプロジェクトを通じて、単純な自動返信から複雑な多ステップビジネスプロセス構築まで掌握了。この学びが后来的AI顧客サービスビジネスに向けた確かな技術基盤を築いた。',
      en: 'In 2025, began deep learning of AI automation and workflow tools. Not just understanding concepts but actually building automation flows with n8n. Main areas: n8n workflow building, AI agent orchestration, API integration, trigger mechanism design. Through real projects, mastered everything from simple auto-replies to complex multi-step business process flows.',
    },
  },
  {
    id: 'tl-037',
    ...
    category: 'milestone',
    isMilestone: true,
    tags: ['Cattery', 'SNS', 'Business'],
    title: {
      zh: '猫舍启程——同时运营5个平台',
      ja: 'キャッテリー开业——5プラットフォームを同時に運営',
      en: 'Cattery Business Launched — Managing 5 Platforms',
    },
    summary: {
      zh: '正式开始猫舍运营，同时管理 Instagram、TikTok、小红书、ブリーダー、LINE 五个平台。',
      ja: '本格的にキャッテリー運営を開始。Instagram、TikTok、小紅書、ブリーダー、LINEの5プラットフォームを同時に管理。',
      en: 'Officially launched cattery operations, managing 5 platforms simultaneously.',
    },
    content: {
      zh: '2024年，猫舍正式开始运营。。每天被5个平台的内容搞得焦头烂额——Instagram、TikTok、小红书、ブリーダー（みんなの子猫ブリーダー）、LINE，全靠一个人扛。内容发布、客户咨询、预约管理、售后服务，每一项都要耗费大量时间精力。也是在那个时候开始思考如何用AI来自动化这些重复性工作。',
      ja: '2024年、キャッテリーが日正式に運営を開始した。每日5つのプラットフォームのやりくりに追われる——Instagram、TikTok、小紅書、ブリーダー（みんなの子猫ブリーダー）、LINE、全て一人で管理。コンテンツ投稿、顧客からの問い合わせ予約管理、アフターサービス每一項目に大量の時間とエネルギーを要する。この頃から、AIを使ってこれらの繰り返し作業を自動化できないかとのんね考え始めた。',
      en: 'In 2024, officially launched cattery operations. Every day overwhelmed by content across 5 platforms — Instagram, TikTok, Xiaohongshu, Breeder platform, and LINE — all managed by one person. Content posting, customer inquiries, reservation management, after-sales service — each consuming massive time and energy. This is when the thinking started: how to use AI to automate these repetitive tasks.',
    },
  },
];
