      ...
      <div className="w-full max-w-md">
        <div className="glass-card p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">{t('sign_in_to_lab')}</p>
          </div>

          <div className="space-y-3 mb-6">
            <button
              onClick={() => signIn('github', { callbackUrl: '/' })}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-[#24292f] hover:bg-[#2f363d] text-white font-medium transition-colors"
            >
