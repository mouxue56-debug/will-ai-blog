      ...
      <body className="min-h-screen flex items-center justify-center bg-[#0a0a0f] text-foreground antialiased">
        <div className="relative overflow-hidden px-4 py-20 sm:px-6 min-h-screen flex items-center justify-center">
          ...
          <div className="relative mx-auto max-w-3xl">
            <div className="rounded-3xl border border-white/10 bg-black/30 p-8 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-10 text-center">
              <h1
              ...
              <p className="mt-3 text-sm leading-7 text-muted-foreground sm:text-base opacity-0 animate-[fadeUp_0.6s_ease-out_0.3s_forwards]">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3 opacity-0 animate-[fadeUp_0.6s_ease-out_0.5s_forwards]">
                <Link
                  href="/"
                  className="inline-flex items-center gap-2 rounded-full bg-brand-cyan/15 px-5 py-2.5 text-sm font-medium text-brand-cyan transition-colors hover:bg-brand-cyan/25 border border-brand-cyan/20"
                >
                  回到首页 / Home
                </Link>
                <Link
        ...
        <style>{`
          ...
          @media (prefers-reduced-motion: reduce) {
            h1, h2, p, .animate-\\[fadeUp_0\\.6s_ease-out_0\\.2s_forwards\\],
            .animate-\\[fadeUp_0\\.6s_ease-out_0\\.3s_forwards\\],
            .animate-\\[fadeUp_0\\.6s_ease-out_0\\.35s_forwards\\],
            .animate-\\[fadeUp_0\\.6s_ease-out_0\\.5s_forwards\\] {
