...
const mockVideos = [
  { gradient: 'from-gray-800 via-gray-700 to-gray-900', emoji: '🐱', title: '猫と暮らす朝のルーティン', likes: '5.2K', views: '28K' },
  { gradient: 'from-gray-900 via-gray-800 to-black', emoji: '🤖', title: 'AIに猫の世話を手伝ってもらう', likes: '3.8K', views: '19K' },
  { gradient: 'from-gray-700 via-gray-800 to-gray-900', emoji: '🍢', title: '大阪ストリートフード巡り', likes: '7.1K', views: '42K' },
];
        ...
        >
          <div className={`bg-gradient-to-b ${v.gradient} aspect-[9/16] flex flex-col items-center justify-center relative`}>
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent p-2 sm:p-3">
              <p className="text-white text-[10px] sm:text-xs line-clamp-2 leading-tight">{v.title}</p>
