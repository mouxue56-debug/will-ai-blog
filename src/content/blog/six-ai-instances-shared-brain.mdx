...
import { EnhancedLayout } from '@/components/blog/enhanced';

<EnhancedLayout sections={[
  { id: "part-1-生态背景", title: "Part 1: 生态背景" },
  { id: "part-2-问题 - 记忆孤岛", title: "Part 2: 记忆孤岛" },
  { id: "part-3-架构总览", title: "Part 3: 架构总览" },
  { id: "part-4-实现细节", title: "Part 4: 实现细节" },
  { id: "part-5-使用场景", title: "Part 5: 使用场景" },
  { id: "part-6-踩坑记录", title: "Part 6: 踩坑记录" },
  { id: "part-7-效果对比", title: "Part 7: 效果对比" },
]}>
