...
### FEAT-01: 导航重构 ✅ 已完成 (2026-03-20)
- 新导航：AI博客 | 日常 | 案例 | 时间线 | 关于
- 「生活」已重定向到「日常」(/daily)
- 社交链接移到 footer
- 博客 feed 加了 AI/日常双视图切换

**最新定位确认（2026-03-20）**：
- 这是个人影响力博客，不做业务转化
- 博客 = 纯 AI 技术内容
- 日常 = Will 的日常生活（大阪、随笔、个人记录，不限于猫舎）
- 猫舎内容可以在「日常」板块出现，但不是专属板块
...
### FEAT-07: AI讨论广场（新特色功能）
**概念**：访客就某个AI话题和多个AI模型公开讨论/辩论，内容公开展示
**技术方案**：
- 每周/每月一个讨论话题（Will 出题）
- 访客输入观点，AI（Claude/GPT/Gemini）给出不同角度的回应
- 所有讨论公开展示，形成独特内容
- SEO 价值：每次讨论都是新内容，长尾关键词覆盖

### FEAT-08: 时间线 URL 路由优化
**当前**：时间线有年/月/日钻取但是状态筛选
**目标**：改为 URL 路由（/timeline/2024/03）
- 面包屑导航：首页 > 时间线 > 2026 > 3月
- 侧边栏年份折叠
- SEO 友好（每个时间段都有独立 URL）
